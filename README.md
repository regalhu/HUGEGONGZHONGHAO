...
- 主页面提供每篇草稿的「图片工具」，自动生成公众号封面、公众号文中配图、小红书封面、视频号/抖音封面的图片提示词，也可以上传图片到正文留白位置。
...
主页面每篇草稿卡片里都有「图片工具」，会自动生成 5 组图片提示词：
...
公众号正文默认预留 4 个图片空白位置：开头后、第 3 句劝后、第 7 句劝后、结尾前。图片生成后，在主页面对应草稿的「图片工具」里上传图片并选择位置，系统会重新生成本地正文。上传公众号草稿箱时，已加载的本地图片会先上传到微信素材域名，再插入到对应位置。
