...
这个项目用于每天自动生成「餐饮要赚钱 听我10句劝」文章、公众号封面图、公众号 HTML 排版，并可在配置公众号密钥后上传到公众号草稿箱。

## 当前能力

- 自动生成一篇每日栏目文章。
- 自动生成公众号封面图 `cover.jpg`，每篇公众号文章固定 1 张封面图。
- 自动渲染公众号正文 HTML。
- 可调用微信公众平台官方接口创建草稿。
...
每篇文章的预览页都有「图片生成工作台」，会自动生成 1 组公众号封面图提示词：

- 公众号封面图，推荐比例 2.35:1

提示词包含图片用途、推荐尺寸比例、中文提示词、英文提示词、风格说明和禁止元素，并提供「复制提示词」按钮。页面上的「打开 ChatGPT 图片生成」会打开 `https://chatgpt.com/`，由你手动粘贴提示词生成图片。

图片生成后，在预览页替换封面图。上传公众号草稿箱时，系统只上传这一张封面图作为公众号封面，正文保持纯文字排版。
...
- 关键词抓取结果：展示最近 5 天公开平台和搜索引擎里的餐饮高频词及提及率
